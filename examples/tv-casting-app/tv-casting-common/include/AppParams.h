...
public:
    ...
    void SetFeatureOverrides(std::map<std::string, int> featureOverrides);
    void GetFeatureOverrides(std::map<std::string, int> &featureOverrides);
...
#endif // CHIP_ENABLE_ROTATING_DEVICE_ID
    std::map<std::string, int> mFeatureOverrides;
};
