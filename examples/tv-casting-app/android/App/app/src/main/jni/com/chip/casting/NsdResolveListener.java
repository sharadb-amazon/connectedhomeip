    ...
    switch (errorCode) {
      case NsdManager.FAILURE_ALREADY_ACTIVE:
        ...
        nsdManager.resolveService(
            serviceInfo,
            new NsdResolveListener(nsdManager, deviceTypeFilter, preCommissionedVideoPlayers, successCallback, failureCallback));
        break;
  ...
  private void addCommissioningInfo(DiscoveredNodeData discoveredNodeData) {
    if(preCommissionedVideoPlayers != null)
    {
      for(VideoPlayer videoPlayer: preCommissionedVideoPlayers)
      {
        ...
        {
          Log.d(TAG, "Matching Video Player with the following information found for discovered node data" + videoPlayer);
