...
class CommissionableDataProviderImplJNI : public chip::DeviceLayer::CommissionableDataProvider
{
public:
...
private:
    friend CommissionableDataProviderImplJNI & CommissionableDataProviderImplJNIMgr();
    static CommissionableDataProviderImplJNI sInstance;
...
inline CommissionableDataProviderImplJNI & CommissionableDataProviderImplJNIMgr()
{
    return CommissionableDataProviderImplJNI::sInstance;
}
