...
class DeviceAttestationCredentialsProviderJNI : public chip::Credentials::DeviceAttestationCredentialsProvider
{
public:
...
private:
    friend DeviceAttestationCredentialsProviderJNI & DeviceAttestationCredentialsProviderJNIMgr();
    static DeviceAttestationCredentialsProviderJNI sInstance;
...
inline DeviceAttestationCredentialsProviderJNI & DeviceAttestationCredentialsProviderJNIMgr()
{
    return DeviceAttestationCredentialsProviderJNI::sInstance;
}
}; // namespace support
}; // namespace casting
}; // namespace matter